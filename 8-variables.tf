...
variable "nonprod_virtual_network_address_space" {
  ...
  type        = list(string)
  default     = ["172.19.99.0/24", "172.19.100.0/24", "172.19.101.0/24", "172.19.102.0/24", "172.19.103.0/24", "172.19.104.0/24"]
}
...
variable "soa_dev_webapp_name" {
  ...
  default = ["mspdevshared", "mspdevaxon", "mspdev", "mspdevbbg", "mspdevedm", "mspdevff", "mspdevfit", "mspdevopd", "mspdevprecis", "mspdevshared", "mspdevtextanalyz", "mspdevtextextr", "mspdevtrio", "soadev"]
}
